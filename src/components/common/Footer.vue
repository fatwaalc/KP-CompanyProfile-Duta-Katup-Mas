<template>
  <footer class="bg-white text-slate-900 mt-auto">
    <div class="max-w-6xl mx-auto px-4 py-14 sm:px-6 lg:px-8 md:py-10">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-10">
        <div class="flex flex-col gap-3 sm:col-span-2 lg:col-span-1 lg:-ml-12 xl:-ml-16">
          <button
            @click="navigateTo('/')"
          ...
          <p class="text-base m-0 mt-1 text-slate-600">{{ t('footer.address') }}</p>
          <p class="text-base m-0 text-slate-600">{{ t('footer.phone') }}</p>
          <a href="mailto:admin@dutakatupmas.co.id" class="email-link text-base m-0 text-slate-600 transition-colors duration-200 w-fit">admin@dutakatupmas.co.id</a>
          <GetInTouchButton class="w-fit mt-2" @click="navigateTo('/contact')" />
        </div>

        <div class="flex flex-col">
          <h4 class="text-sm font-bold text-slate-900 m-0 mb-4">{{ t('footer.section.home') }}</h4>
        ...
        <div class="flex flex-col">
          <h4 class="text-sm font-bold text-slate-900 m-0 mb-4">{{ t('footer.section.about') }}</h4>
          <ul class="list-none p-0 m-0 flex flex-col gap-2.5">
        ...
        <div class="flex flex-col">
          <h4 class="text-sm font-bold text-slate-900 m-0 mb-4">{{ t('footer.section.services') }}</h4>
          <ul class="list-none p-0 m-0 flex flex-col gap-2.5">
        ...
        <div class="flex flex-col">
          <h4 class="text-sm font-bold text-slate-900 m-0 mb-4">{{ t('footer.section.products') }}</h4>
          <ul class="list-none p-0 m-0 flex flex-col gap-2.5">
      ...
      <div class="h-px bg-linear-to-r from-transparent via-slate-200 to-transparent my-8"></div>

      <div class="flex justify-center items-center">
        <p class="text-xs text-slate-500 m-0 text-center">{{ t('footer.copyright') }}</p>
      </div>
    </div>
  </footer>
</template>
...
const navigateTo = async (path, hash = '') => {
  if (hash) {
