  ...
  <section class="py-16 md:py-12 sm:py-8 px-8 sm:px-4 bg-linear-to-br from-dkm-light-blue to-blue-100">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="text-center mb-12">
        ...
        <h2 class="text-5xl md:text-4xl sm:text-3xl font-bold text-dkm-dark m-0">
      ...
      <div class="relative w-full pt-[56.25%] h-0 bg-black rounded-xl overflow-hidden shadow-2xl mb-8 group">
        ...
        <div class="absolute bottom-0 left-0 right-0 flex items-center justify-between px-4 py-4 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-5">
          <button 
