...
npm run preview
```
Melakukan preview terhadap production build secara lokal.

## 📊 Performance Optimizations

- ✅ **Code Splitting**: Automatic route-based code splitting dengan Vue Router
- ✅ **Tree Shaking**: Unused code elimination di production build
- ✅ **Asset Optimization**: Compressed images dan minified CSS/JS via Vite
- ✅ **Lazy Loading**: Dynamic imports untuk components dan routes
- ✅ **CSS Scoping**: Scoped component CSS + Tailwind utility classes
- ✅ **Tailwind Purging**: Automatic removal of unused CSS classes di build
- ✅ **HMR**: Fast module replacement during development

## 🔄 Git Workflow

```bash
# Clone repository
git clone https://github.com/yourusername/company-profile-dkm.git
...
- [x] LogosMarquee component
- [x] TestimonialCard component
- [x] VisionMissionCard component dengan Goal icons
- [x] EquipmentCard component
- [x] FacilitiesCard component

### Phase 2 - Design System ✅
- [x] Blue gradient backgrounds
- [x] Color palette implementation
- [x] Standardized carousel buttons
- [x] Consistent hover effects

### Phase 3 - Interactivity ✅
- [x] Active state navbar tracking
- [x] Animated hover effects (underline + left border)
- [x] Dropdown menu delay management
- [x] Smooth carousels with auto-advance

### Phase 4 - Responsive Design ✅
- [x] Mobile text overflow fixes
- [x] Tablet layout optimization
- [x] Touch-friendly button sizes
- [x] Responsive typography

### Phase 5 - Polish & Fixes ✅
- [x] GetInTouchButton icon updated to Send
- [x] All navigation active states working
- [x] Dropdown menus functioning smoothly
- [x] Email text wrapping on mobile
...
Untuk pertanyaan atau feedback tentang website ini:

- **Email**: contact@dkm.com
- **Phone**: +62 (0)XXX-XXXX-XXXX
- **Website**: www.dkm.com
- **Address**: [Company Address]

## 📄 Lisensi

Proyek ini dilindungi oleh lisensi proprietary. Hanya untuk penggunaan internal PT. Duta Katup Mas.

## 🙏 Acknowledgments

- Vue.js documentation dan community
- Vite untuk build tooling yang amazing
- Lucide Vue Next untuk beautiful icons
- Design inspiration dari modern web practices
...
- [ ] Mobile layout optimization untuk beberapa sections
- [ ] Video loading optimization untuk CompanyVideoSection
- [ ] Certifications carousel auto-advance timing
- [ ] Newsletter signup integration
- [ ] Multi-language support (EN/ID)

---

**Status Proyek**: ✅ Beta (Deployable)  
**Last Updated**: April 17, 2026  
**Version**: 1.0.0-beta  
**Build Status**: ✅ Working with Tailwind CSS v4.0 + Vite 8.0
